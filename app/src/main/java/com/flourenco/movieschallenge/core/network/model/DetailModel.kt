...
data class DetailModel(
    ...
    @field:Json(name = "directors") val directors: String?,
    @field:Json(name = "writers") val writers: String?,
    @field:Json(name = "companies") val companies: String?,
    @field:Json(name = "countries") val countries: String?,
